...
typewriter.typeString("what's up!")
    ...
    .deleteAll()
    .pauseFor(500)
    .typeString("my name is nathanael.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("i'm a student at lipscomb university (go bisons!).")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    ...
    .deleteAll()
    .pauseFor(500)
    .typeString("i'm also interested in math.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    ...
    .deleteAll()
    .pauseFor(500)
    .typeString("i also like to trade stocks and crypto.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
